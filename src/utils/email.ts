...
export function sendEmailGastronomy(email: string, data: EmailDataGastronomy) {
...
export function sendEmailEvents(email: string, data: EmailDataEvents) {
  const textUser = `<!DOCTYPE html>
<html lang="es">
<head>  <meta charset="UTF-8">
  <title>Confirmación de Reserva – Punto Serrano</title>
...
<body>
  <div class="container">
    <h1>📩 Confirmación de solicitud de Reserva – Punto Serrano</h1>
